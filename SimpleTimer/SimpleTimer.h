...
public:
	...
	inline virtual int setInterval(long d, timer_callback f);

    // call function f once after d milliseconds
	virtual int setTimeout(long d, timer_callback f);

    // call function f every d milliseconds for n times
	virtual int setTimer(long d, timer_callback f, int n);

    // destroy the specified timer
	virtual void deleteTimer(int numTimer);

    // restart the specified timer
	virtual void restartTimer(int numTimer);

    // returns true if the specified timer is enabled
	virtual boolean isEnabled(int numTimer);

    // enables the specified timer
	virtual void enable(int numTimer);

    // disables the specified timer
	virtual void disable(int numTimer);
